...
from util.common import funcs_individual, funcs_cascading__s4__m1_to_1
...
if i_task == 1:
    ...
    if LRP:
        mat_funcs = funcs_cascading__s4__m1_to_1(model)
...
if i_task == 2:
    ...
    pickle_key =   ('s4f5', 'svals__m1_to_1___cascading_gamma__gammas40')
...
if i_task == 3:
    ...
    pickle_key =   ('s4f7', 'svals__m1_to_1___cascading_gamma__gammas40')
...
if i_task == 4:
    ...
    pickle_key =   ('s4f9', 'svals__m1_to_1___cascading_gamma__gammas40')
...
if i_task == 5:
    ...
    pickle_key =   ('s4f11', 'svals__m1_to_1___cascading_gamma__gammas40')
